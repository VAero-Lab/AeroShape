...
GitHub natively supports interactive 3D viewing for STL files. Click the link below to view an example model generated by AeroShape:

[**View Blended Wing Body 3D Model**](Exports/blended_wing_body.stl)
